...
const AIRoutineGenerator = () => {
  ...
  const generateRoutine = async () => {
    ...
    try {
      ...
      if (!apiKey) {
        throw new Error('AI API key is not configured. Please add GEMINI_API_KEY to your environment variables.');
      }
      ...
      const response = await ai.models.generateContent({
        ...
        contents: prompt,
        config: { 
          systemInstruction: `You are a yoga routine generator. 
          Return the response in strictly JSON format: { "title": "Routine Name", "description": "Why this routine is good for your mood", "poses": ["Pose Name 1", "Pose Name 2", ...] }`,
