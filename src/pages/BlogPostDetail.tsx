  ...
  if (!post) {
    return (
      <div className="pt-32 pb-24 min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <Link to="/blog" className="bg-primary-600 text-white px-8 py-3 rounded-xl font-bold">
          Back to Blog
        </Link>
      </div>
    );
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-stone-500 hover:text-primary-600 transition-colors mb-12 group"
        >
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap items-center gap-8 text-stone-400 text-sm font-medium border-y border-stone-100 py-6">
            ...
            <div className="ml-auto flex items-center gap-4">
              <button className="p-2 hover:bg-stone-50 rounded-lg transition-colors text-stone-400 hover:text-primary-600">
        ...
        <article className="prose prose-stone prose-lg max-w-none">
          <div className="text-stone-600 leading-relaxed space-y-8">
            <p className="text-xl font-medium text-stone-800 italic border-l-4 border-primary-500 pl-6 py-2">
              {post.excerpt}
            </p>
        ...
        <div className="mt-24 p-12 bg-stone-50 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-8">
          <div className="w-24 h-24 bg-primary-200 rounded-full flex-shrink-0 overflow-hidden">
            <img 
